...
//Initialize the instance variables
    ...
    public double getReal() {
        return this.reNum;	//A stub: to be fixed
    }
    ...
    public double getImaginary() {
        return this.imNum;	//A stub: to be fixed
    }
    ...
    public ComplexNumber negate() {
        ComplexNumber b = new ComplexNumber(this.reNum*(-1),this.imNum*(-1));
    ...
    public ComplexNumber add(ComplexNumber z) {
        ComplexNumber d = new ComplexNumber(this.reNum + z.getReal(),this.imNum + z.getImaginary());
    ...
    public ComplexNumber subtract(ComplexNumber z) {
        ComplexNumber e = new ComplexNumber(this.reNum - z.getReal(),this.imNum - z.getImaginary());
    ...
    public ComplexNumber multiply(ComplexNumber z) {
        double a, b;        
        ComplexNumber h;
        a = (this.reNum * z.getReal()) - (this.imNum * z.getImaginary());
        b = (this.reNum * z.getImaginary()) + (this.imNum * z.getReal());
     ...
     * @return 1.0 / this
     */
    public ComplexNumber reciprocal() { //Need to modify still
        ComplexNumber f;
        double a, b, x, imVal, reVal;
        a = this.getReal();
        b = this.getImaginary();
        x = a*a+b*b;
        reVal = a/x;
        imVal =(-1)*b/x;
        f = new ComplexNumber(reVal,imVal);        
    ...
    public ComplexNumber divide(ComplexNumber z) {
        ...
        e = new ComplexNumber (this.reNum, this.imNum);
        b = e.multiply(a);
        c = z.multiply(a);
